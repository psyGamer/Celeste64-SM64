...
// Channel 9 loads sounds from the same place as channel 5.
    ...
    public enum SM64MarioAnimID : int
    {
        ...
        /* 0x38 */ QUICKLY_PUT_CAP_ON, // unused
        ...
        /* 0x51 */ START_FORWARD_SPINNING, // unused
        /* 0x52 */ THROW_LIGHT_OBJECT,
        /* 0x53 */ FALL_FROM_SLIDE_KICK,
        /* 0x54 */ BEND_KNESS_RIDING_SHELL, // unused
        ...
        /* 0x61 */ UNLOCK_DOOR,
        /* 0x62 */ START_REACH_POCKET, // unused, reaching keys maybe?
        /* 0x63 */ REACH_POCKET, // unused
        /* 0x64 */ STOP_REACH_POCKET, // unused
        /* 0x65 */ GROUND_THROW,
        /* 0x66 */ GROUND_KICK,
        /* 0x67 */ FIRST_PUNCH,
        /* 0x68 */ SECOND_PUNCH,
        ...
        /* 0x71 */ BREAKDANCE,
        /* 0x72 */ RUNNING,
        /* 0x73 */ RUNNING_UNUSED, // unused duplicate, originally part 2?
        /* 0x74 */ SOFT_BACK_KB,
        /* 0x75 */ SOFT_FRONT_KB,
        ...
        /* 0xA2 */ WATER_ACTION_END_WITH_OBJ, // either swimming or flutterkicking
        ...
        /* 0xAB */ SWIM_PART2,
        /* 0xAC */ FLUTTERKICK,
        /* 0xAD */ WATER_ACTION_END, // either swimming or flutterkicking
        ...
        /* 0xCA */ START_TIPTOE,
        /* 0xCB */ SLIDEJUMP, // pole jump and wall kick
        /* 0xCC */ START_WALLKICK,
        /* 0xCD */ STAR_DANCE,
    ...
    public enum SM64IntSubtype : uint
    {
        NONE = 0x00000000,
