...
public partial class Sm64Context
{
    ...
    private static void PlaySoundFuncDelegateWrapper_(uint soundBits, ref LowLevelSm64Vector3f position)
    {
    ...
    public static void RegisterPlaySoundFunction(PlaySoundFuncDelegate handler)
    {
