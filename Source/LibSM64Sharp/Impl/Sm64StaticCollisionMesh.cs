...
{
    public ISm64StaticCollisionMeshBuilder CreateStaticCollisionMesh() => new Sm64StaticCollisionMeshBuilder();

    private class Sm64StaticCollisionMeshBuilder : ISm64StaticCollisionMeshBuilder
    {
        private readonly List<ISm64Triangle> triangles_ = [];

        public ISm64StaticCollisionMesh Build() => new Sm64StaticCollisionMesh(triangles_);
