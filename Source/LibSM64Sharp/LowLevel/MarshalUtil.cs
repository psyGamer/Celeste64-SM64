...
{
    public static unsafe T? MarshalRef<T>(T* ptr) where T : unmanaged => MarshalRef<T>(new IntPtr(ptr));

    public static T? MarshalRef<T>(IntPtr ptr) => ptr.ToInt64() != 0 ? Marshal.PtrToStructure<T>(ptr) : default;
